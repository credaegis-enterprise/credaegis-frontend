...
interface NotifBoxOrganizationProps {
...
const NotifBoxOrganization: React.FC<NotifBoxOrganizationProps> = ({ notfications,getNotifications }) => {
...
export default NotifBoxOrganization;
