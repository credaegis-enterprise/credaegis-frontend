...
const SideBar = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div
        className={`flex items-center bg-white dark:bg-stone-900 rounded-lg shadow-sm p-4 transition-colors duration-300 hover:bg-gray-100 dark:hover:bg-stone-700 cursor-pointer ${
          settingsTab.id === "General" ? "bg-gray-300 dark:bg-stone-600" : ""
        }`}
        onClick={() => setSettingsTab({ type: "settings", id: "General" })}
      >
      ...
      <div
        className={`flex items-center bg-white dark:bg-stone-900 rounded-lg shadow-sm p-4 transition-colors duration-300 hover:bg-gray-100 dark:hover:bg-stone-700 cursor-pointer ${
          settingsTab.id === "Security" ? "bg-gray-300 dark:bg-stone-600" : ""
        }`}
      ...
      <div
        className={`flex items-center bg-white dark:bg-stone-900 rounded-lg shadow-sm p-4 transition-colors duration-300 hover:bg-gray-100 dark:hover:bg-stone-700 cursor-pointer ${
          settingsTab.id === "Preferences" ? "bg-gray-300 dark:bg-stone-600" : ""
        }`}
