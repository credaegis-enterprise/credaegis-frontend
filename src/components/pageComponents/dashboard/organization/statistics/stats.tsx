  ...
  return (
    <div className="flex flex-col h-full p-6 rounded-lg shadow-lg">
      <div className="grid grid-rows-2 h-full gap-6">
        ...
        <div className="row-span-1 flex flex-col h-full gap-4  ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 overflow-auto">
            
            <div className="flex flex-col h-full overflow-auto  gap-4 border border-gray-200 dark:border-stone-800 rounded-lg p-4 shadow-md">
        ...
        <div className="row-span-1 flex flex-col gap-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 overflow-auto">
            {/* Top Cluster Stats */}
            <div className="flex flex-col gap-4 border overflow-auto border-gray-200 dark:border-stone-800 rounded-lg p-4 shadow-md">
              <div className="flex items-center gap-2 text-lg font-semibold text-gray-900 dark:text-white">
            ...
            {/* Top Event Stats */}
            <div className="flex flex-col gap-4 border border-gray-200 dark:border-stone-800 rounded-lg p-4 shadow-md overflow-auto">
              <div className="flex items-center gap-2 text-lg font-semibold text-gray-900 dark:text-white ">
