    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <section className="mb-6">
        ...
        <p className="text-lg text-gray-700">
          This is a static page example created to demonstrate how a simple
          layout can be implemented in a React component. The content is static
          and does not change.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5">
          ...
          <li className="text-lg mb-2">
            Feature 2: Basic layout styling with Tailwind CSS
          </li>
          <li className="text-lg mb-2">
            Feature 3: Responsive design with padding and margins
          </li>
        </ul>
      </section>
